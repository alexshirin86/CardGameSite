...
namespace CardGameSite.DAL.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryProductProduct", x => new { x.CategoriesProductId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_CategoryProductProduct_CategoriesProduct_CategoriesProductId",
